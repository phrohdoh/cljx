...
pub fn get_last_or(default: RcValue) -> impl Fn(&List) -> RcValue {
...
/// provided function.
pub fn get_last_or_else(else_fn: impl Fn(&List) -> RcValue) -> impl Fn(&List) -> RcValue {
...
pub fn get_nth(n: usize) -> impl Fn(&List) -> Option<RcValue> {
...
pub fn get_nth_or(n: usize, default: RcValue) -> impl Fn(&List) -> RcValue {
...
pub fn get_nth_or_nil(n: usize) -> impl Fn(&List) -> RcValue {
...
pub fn get_nth_or_else(n: usize, else_fn: impl Fn(&List) -> RcValue) -> impl Fn(&List) -> RcValue {
